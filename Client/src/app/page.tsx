            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 border border-green-200">
                ...
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center bg-green-600 text-white py-3 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 font-semibold"
                >
                  Create Custom Plan
                </Link>
              </div>
